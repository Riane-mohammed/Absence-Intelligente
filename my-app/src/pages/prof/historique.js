        ...
        <table className='mx-auto my-2'>
          <thead>
            <tr className='bg-gray-200'>
              ...
              <td className='font-bold'>Nombre d'absences</td>
              <td className='font-bold text-center'>Module</td>
          ...
          <tbody>
            {students.map((student) =>
              <tr key={student.id} className='border-b-2'>
                <td className='pl-1 pr-4'>{student.studentName}</td>
                <td className='pl-1 pr-4 text-center' >{student.nombre_abs}</td>
                <td className='pl-1 pr-4' >{student.courseName}</td>
